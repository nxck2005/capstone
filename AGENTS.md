...
global quality counts 423–424, every class range 0–1, no duplicate pair. No
artifacts materialized. G8_F remains unstarted and unauthorized. Next:
**owner audit of the AM-88 sampler plan, then a separate F0 authorization only**.
