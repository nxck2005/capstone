...
**Implementation started 2026-07-28. W1, W2 and W3 are complete; G-9, G-1, G-7 and G-2 passed; the validation-only transparency-bitrate probe is complete and lineage-bound.** The frozen G-1 checkpoint remains `9c37362347a0203597d6e8e9d9a58fde30ba286f3cec9b4d2f800bd8a3256002` with config `a9717575d71f2b3e9dd411b10b7735bdb3946c985fead48cb3c5af07423f12e1`; W2's immutable implementation commit remains `26b631ede27a6f88f1d004a66b845c52a658e07c`. The probe reproduced 898/1000 over 68,000 validation cells with zero infeasible encodes or decode failures and did not select a G-8 ratio. W3's immutable implementation commit is `968e907237bbe571adf6ec48e4711ea021831719`. G-2 passed its srsRAN exact vectors, project-owned offline floor, mapper/demapper/interleaver and CRC known answers, independent flooding-OMS BLER comparison, and all 216 packetisation/runtime cells: waterfall displacements were 0.0 dB for BPSK, +0.0036302379 dB for QPSK and 0.0 dB for 16-QAM against the 0.5 dB limit. The test split stayed sealed and no model training ran. **W4 is now complete**, including the PB_3C correction. The single next task is the **G-8 classical validation work**, and it begins with **campaign implementation and preflight** rather than with the sweep: the sweep is step eight of twelve. The committed G-2 BLER evidence characterises one physical-layer identity at four SNR points per modulation — a conformance artifact that remains valid for G-2 and **must not be extrapolated into the BR-4 characterization table**. G-8 must first enumerate the structural candidate/configuration and code-block identity grids, run and archive full-strength BR-4 physical-layer BLER characterization, build a hash-bound G-8 `BlerTable` and verify complete coverage, and produce measured codec/clean-classifier accuracies from verified artifacts — then execute pass one, build the training-only artifact corpus, fine-tune the artifact classifier, execute pass two once, and adjudicate. See `NEXT.md` §"What G-8 actually has to build". Do not calibrate λ, train learned models, implement ER-9 or evaluate on test before their gates.
