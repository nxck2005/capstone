...
**Implementation started 2026-07-28. W1, W2 and W3 are complete; G-9, G-1, G-7 and G-2 passed; the validation-only transparency-bitrate probe is complete and lineage-bound.** The frozen G-1 checkpoint remains `9c37362347a0203597d6e8e9d9a58fde30ba286f3cec9b4d2f800bd8a3256002` with config `a9717575d71f2b3e9dd411b10b7735bdb3946c985fead48cb3c5af07423f12e1`; W2's immutable implementation commit remains `26b631ede27a6f88f1d004a66b845c52a658e07c`. The probe reproduced 898/1000 over 68,000 validation cells with zero infeasible encodes or decode failures and did not select a G-8 ratio. W3's immutable implementation commit is `968e907237bbe571adf6ec48e4711ea021831719`. G-2 passed its srsRAN exact vectors, project-owned offline floor, mapper/demapper/interleaver and CRC known answers, independent flooding-OMS BLER comparison, and all 216 packetisation/runtime cells: waterfall displacements were 0.0 dB for BPSK, +0.0036302379 dB for QPSK and 0.0 dB for 16-QAM against the 0.5 dB limit. The test split stayed sealed and no model training ran. **W4 and G8_A are complete. G8_B active. B0, B1, B1C and B2 complete. B3 next — implement exact resume and merge validation. No runner, simulation, smoke or characterization has started. G8_C–G8_G remain prohibited.** G8_A froze the pre-data contract, 12,096-cell structural grid, 3,213 required BLER work units, honest zero-cell G-2 exact coverage, and crash-safe state without running characterization or a sweep. G8_B is tooling and bounded smoke only. B1 froze the historical BLER runner contract, deterministic seed derivation and work-unit design; B1C corrected and hardened the executable contract before data, and B2 froze deterministic sharding and atomic per-unit state without beginning work. The seven-phase G-8 campaign remains partitioned under `instructions/G8.txt` and `instructions/G8_A.txt` through `G8_G.txt`; later phases may not silently reinterpret earlier artifacts. The committed G-2 BLER evidence remains a narrow conformance artifact and **must not be extrapolated into the BR-4 characterization table**. Do not begin G8_C or anything later until G8_B is green; do not calibrate λ, train learned models, implement ER-9 or evaluate on test before their gates.

**Current action: G8_B B3 — implement exact resume and merge validation.** On resumption, `instructions/RESUME.md` remains the single operational cursor. **G8_B active. B0, B1, B1C and B2 complete. B3 next — implement exact resume and merge validation. No runner, simulation, smoke or characterization has started. G8_C–G8_G remain prohibited.**
