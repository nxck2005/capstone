...
**Implementation started 2026-07-28. W1, W2 and W3 are complete; G-9, G-1, G-7 and G-2 passed; the validation-only transparency-bitrate probe is complete and lineage-bound.** The frozen G-1 checkpoint remains `9c37362347a0203597d6e8e9d9a58fde30ba286f3cec9b4d2f800bd8a3256002` with config `a9717575d71f2b3e9dd411b10b7735bdb3946c985fead48cb3c5af07423f12e1`; W2's immutable implementation commit remains `26b631ede27a6f88f1d004a66b845c52a658e07c`. The probe reproduced 898/1000 over 68,000 validation cells with zero infeasible encodes or decode failures and did not select a G-8 ratio. W3's immutable implementation commit is `968e907237bbe571adf6ec48e4711ea021831719`. G-2 passed its srsRAN exact vectors, project-owned offline floor, mapper/demapper/interleaver and CRC known answers, independent flooding-OMS BLER comparison, and all 216 packetisation/runtime cells: waterfall displacements were 0.0 dB for BPSK, +0.0036302379 dB for QPSK and 0.0 dB for 16-QAM against the 0.5 dB limit. The test split stayed sealed and no model training ran. **W4 is now complete**, including the PB_3C correction. **G8_A is active and is the only permitted task:** execute `instructions/G8_A.txt` from its current ledger checkpoint. The seven-phase G-8 campaign is partitioned under `instructions/G8.txt` and `instructions/G8_A.txt` through `G8_G.txt`; G8_A freezes only the pre-data contract, structural grid, required BLER identities, and crash-safe state. It runs no characterization, validation measurement, selection pass, training, or adjudication. The committed G-2 BLER evidence remains a narrow conformance artifact and **must not be extrapolated into the BR-4 characterization table**. Do not begin G8_B or anything later until G8_A is green; do not calibrate λ, train learned models, implement ER-9 or evaluate on test before their gates.

**Live next action while G8_A is active: Execute `instructions/G8_A.txt` from A0.** On resumption, `instructions/RESUME.md` identifies the first incomplete checkpoint.
