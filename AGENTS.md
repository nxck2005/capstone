...
binding F1 source commit `c437ff80eebd464ee7b256f2e69240a7d2f514a8`, profile
...
optimizer step, pass two or test access occurred; the F1 runtime is absent.
**F1 is not started and requires a separate owner/operator launch action.**
