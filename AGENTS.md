...
remains green and closed. G8_D is GREEN and closed; G8_E/E0 is the next
authorized gate but has not started. Do not reopen or rerun G8_C, do not start
G8_E, and do not run the full validation campaign yet.
...
G8_E/E0 is authorized next but has not started; do not start it or run the full
validation campaign yet. C3-C7 closeout is now bound by
