...
invoke fallback, adjudicate ratios or access test. **AM-87 now resolves the
post-pass-one BR-12 breadth defect at protocol level:** metadata-only plan
`g8fcorpusplan-6320ea3e5299a2175a730a2cb8c2d835e756bd11e7424f4b1221948f6f148148`
freezes 120 exact deduplicated artifact-quality requests over all 8,469 training
stable IDs (1,016,280 ordered attempts), no artifacts materialized. G8_F remains
unstarted and unauthorized. Next: **owner audit of the corrected corpus plan,
then a separate F0 authorization only**.
