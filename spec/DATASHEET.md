...
| `channel.train_snr_db_set` | 1, 4, 7, 13, 19 | AM-45, AM-95, ER-2 |
| `channel.train_snr_randomisation_distribution` | discrete_uniform | AM-95 |
| `channel.train_snr_randomisation_unit` | per_sample_per_epoch | AM-95 |
| `channel.train_snr_randomisation_rng_purpose` | er2_snr_randomised_v1 | AM-95, ER-2 |
...
| `artifacts.rng_purposes` | channel_noise, training_channel_noise, outage_label, augmentation, init, batch_order, er2_snr_randomised_v1 | AM-78, AM-91, AM-95, SR-13, SR-18 |
...
| `artifacts.rng_identity_fields.er2_snr_randomised_v1` | dataset_version, split_manifest_hash, stable_sample_id, train_seed, epoch | AM-78, SR-13 |
