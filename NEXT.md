...
**Last updated:** 2026-08-01 · **Phase:** **G8_B active; B0 and B1 complete; B2 next. G8_C–G8_G remain prohibited.**
...
| W4 · PB_2C | complete |
| W4 · PB_3 | complete |
| G-8 classical validation work | **G8_B active; B0 and B1 complete; B2 next — implement sharding and atomic unit state.** |
| G8_B–G8_G | **G8_B active; B0 and B1 complete; G8_C–G8_G prohibited until the preceding phase is green** |
...
**G8_B is active; B0 and B1 are complete and B2 is next.** B0 verified G8_A and opened the phase. B1 froze the BLER runner request/result schemas, the deterministic seed derivation and the RNG stream contract — contracts only; the characterization runner does not exist yet. B2 implements sharding and atomic unit state. G8_B builds characterization tooling and runs bounded synthetic/unit-scale smoke only; it must not run full-strength characterization. No characterization or smoke has started. On resumption, `instructions/RESUME.md` identifies the first incomplete checkpoint.
...
9. **G-8 classical validation work — campaign implementation and preflight, then the full BR-4
   validation sweep and the operating-point decision. G8_B is active; B0 and B1 are complete and B2 is next.** The sweep is step eight
