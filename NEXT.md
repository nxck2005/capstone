...
**Last updated:** 2026-08-18 · **Phase:** **G8_C remains green and closed; D0, D1, D2, D3, D4, D5 and D6 are complete and G8_D D7 is current. The old local G8_C campaign remains immutable superseded history.**
...
<!-- capstone-current-pascal-state: execution=complete; coverage=3213/3213; evidence=published; next=g8-d-d7; bler_table=frozen; g8_d=d6-complete; readiness_state=immutable-zero-coverage-history; runtime_state=completed-production-state; rerun=forbidden; old_local=immutable-zero-successor-coverage -->
...
**Next-session task:** continue only the repository-defined G8_D D7 gate
procedure. G8_C is green and closed, D0, D1, D2, D3, D4, D5 and D6 are complete, and its Pascal successor table is frozen;
do not rerun or resume either campaign, reopen C3-C7, substitute predecessor
table tools, start later G8_D stages out of order, start G8_E, or run the full
validation campaign.
...
| W4 · PB_2C | complete |
| W4 · PB_3 | complete |
| G-8 classical validation work | **next — G8_D D7 current; D0/D1/D2/D3/D4/D5/D6 complete; successor execution and C3-C7 closeout complete at 3213/3213** |
| G8_B–G8_G | **G8_B complete; G8_C GREEN with successor BLER table frozen; G8_D D0/D1/D2/D3/D4/D5/D6 complete; D7 current.** |
...
The test split and every later scientific phase remain closed. G8_D D0, D1, D2, D3,
D4, D5 and D6 are complete and D7 is the current ordered gate; later G8_D stages, G8_E and the
full validation campaign remain closed.
...
G8_D D0, D1, D2, D3, D4, D5 and D6 are complete and D7 is current; do not start later G8_D stages out of
...
frozen; G8_D D0, D1, D2, D3, D4, D5 and D6 are complete and D7 is current. The full BR-4 validation sweep and operating-point
