...
**Last updated:** 2026-08-17 · **Phase:** **G8_C remains green and closed; D0 and D1 are complete and G8_D D2 is current. The old local G8_C campaign remains immutable superseded history.**
...
**Next-session task:** continue only the repository-defined G8_D D2 gate
procedure. G8_C is green and closed, D0 and D1 are complete, and its Pascal successor table is frozen;
...
| W4 · PB_2C | complete |
| W4 · PB_3 | complete |
| G-8 classical validation work | **next — G8_D D2 current; D0/D1 complete; successor execution and C3-C7 closeout complete at 3213/3213** |
| G8_B–G8_G | **G8_B complete; G8_C GREEN with successor BLER table frozen; G8_D D0/D1 complete; D2 current.** |
...
The test split and every later scientific phase remain closed. G8_D D0 is
complete and D1 is the current ordered gate; later G8_D stages, G8_E and the
...
G8_D D0 is complete and D1 is current; do not start later G8_D stages out of
...
frozen; G8_D D0 is complete and D1 is current. The full BR-4 validation sweep and operating-point
