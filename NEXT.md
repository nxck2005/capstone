...
disabled. Only F2 artifact-classifier training may open after its source,
preflight and execution authorization are frozen/pushed and every launch gate
passes; F3 inference/pass two, fallback, ratio adjudication, learned training and
test remain closed.**
