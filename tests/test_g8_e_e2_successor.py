...
def test_contract_binds_its_tracked_scientific_data_identity_file():
    """The contract names a tracked repository path whose bytes authenticate.

    This is the portable half of the runner's data-identity gate: the full
    identity FILE — never the contract's summary block — carries the bound
    ID, and it must be loadable from tracked bytes alone.
    """
