...
**Last durable checkpoint:** `a32fc03994c16559b34180fd611e0b2665c6391c` (C1.2)
**Next action:** require an explicit `encode_axis_px` to be a member of `configured_axes(dataset, canonical_shorter_side)` before JPEG-2000 runs (C1.4)
