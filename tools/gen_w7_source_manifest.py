...
SOURCES = {
    ...
    "src/data/adapters.py": "dataset_source_adapters",
    ...
    "src/data/manifests.py": "split_manifest_loader",
    "src/data/preprocessing.py": "canonical_preprocessing_and_psnr",
    "src/data/provenance.py": "dataset_provenance",
    "src/data/registry.py": "dataset_registry_test_sealed",
    "src/data/test_access.py": "guarded_test_boundary",
    ...
    "src/training/djscc.py": "historical_w5_training_engine",
    ...
    "tools/verify_w5_training_system.py": "w5_reauthentication_verifier",
    "tools/verify_w6_complete.py": "w6_reauthentication_verifier",
    "tools/freeze_w7_profile.py": "profile_freeze_builder",
    "tools/confirm_w7_profile_binding.py": "final_source_profile_confirmation",
    "tests/test_djscc_loss.py": "djscc_loss_regressions",
    "tests/test_djscc_model.py": "djscc_model_regressions",
    "tests/test_djscc_training.py": "historical_w5_training_regressions",
    "tests/test_w5_training_system.py": "w5_compatibility_regressions",
