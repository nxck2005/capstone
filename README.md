...
records **twenty-four amendment rounds** across 94 `AM` entries, and is the file to read before
...
```bash
.venv/bin/python tools/gen_spec_views.py --check       # 204 requirements, 10 generated files
