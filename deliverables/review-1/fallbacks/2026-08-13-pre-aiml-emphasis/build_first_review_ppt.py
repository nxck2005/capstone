...
def build_minimal_scenes() -> list[SlideScene]:
    ...
    gantt_rows = [
        ("BLER characterization + G-8", date(2026, 8, 9), date(2026, 8, 23), "PAUSED → PLANNED", "555555", WHITE),
        ("First Review package", date(2026, 8, 11), date(2026, 8, 23), "ACTIVE / REVIEW", "999999", WHITE),
        ("DJSCC training + calibration", date(2026, 8, 24), date(2026, 9, 21), "PLANNED", "D9D9D9", INK),
        ("Digital control + validation", date(2026, 9, 21), date(2026, 10, 5), "PLANNED", "D9D9D9", INK),
    ...
    contingency_y = chart_y0 + 6 * row_h
    ...
    s.text(0.78, 6.54, 11.45, 0.22,
           "Dark bars show current Review 1 work; light bars are planned. W16 is report contingency, not new experiment scope.",
