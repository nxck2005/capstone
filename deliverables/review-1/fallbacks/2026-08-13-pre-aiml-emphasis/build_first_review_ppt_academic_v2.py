...
def build_scenes() -> list[SlideScene]:
    ...
    gantt_rows = [
        ...
        ("DJSCC training + calibration", date(2026, 8, 24), date(2026, 9, 21), "PLANNED", GREEN, WHITE),
        ("Digital control + validation", date(2026, 9, 21), date(2026, 10, 5), "PLANNED", BURGUNDY, WHITE),
