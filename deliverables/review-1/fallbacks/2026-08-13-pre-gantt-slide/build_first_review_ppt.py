...
def build_minimal_scenes() -> list[SlideScene]:
    ...
    s.text(3.04, 5.67, 8.76, 0.58,
           "The research question, three-system methodology, feasibility evidence and completion plan are defined. The final learned-versus-classical result remains future work.",
