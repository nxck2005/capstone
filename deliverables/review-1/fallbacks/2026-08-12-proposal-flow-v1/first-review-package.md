...
10. close with the requested decisions and rubric map.
...
| 13:50–15:00 | 12 | What should the panel confirm? | Project summary, requested decisions and explicit six-criterion map |
...
### Slide 12 — Summarize and request decisions

Summarize the problem, proposal, current readiness and next work. Ask the panel to confirm the research question, three-system methodology, fairness controls, completion objectives and simulation-first Tier 1. Map all six rubric criteria to slide numbers explicitly.
...
|---|---:|---|---|
| Motivation | 2–4, 6, 11 | — | PENDING — proposal-flow draft present; awaiting author review |
| Objectives | 6–7, 11–12 | `spec/SPEC.md`; this review package | PENDING — proposal-flow draft present; awaiting author review |
| Hypothesis | 8 | `spec/SPEC.md` §2 preregistration | PENDING — exact rule is present; awaiting author review |
| Problem Survey | 5 | `docs/literature-review.md` (30 synthesized references) | PENDING — backing artifact passes; draft PPT awaits author review |
| Subject Knowledge | 3–5, 7–9, 11 | Architecture notes; G-1/G-2/G-7/W4/current G8_C evidence | PENDING — draft PPT present; requires four-member human confirmation |
