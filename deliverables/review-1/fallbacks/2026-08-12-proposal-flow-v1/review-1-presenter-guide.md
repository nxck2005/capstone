...
## Slide 12 — Summary and requested decisions

Purpose: close the proposal rather than ending on an equation or an internal
status item.
...
Ask the panel to confirm the research question, three-system methodology,
fairness controls, completion objectives and simulation-first Tier 1. Point to
the rubric map as evidence that all six First Review criteria are covered.
