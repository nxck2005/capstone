...
def build_minimal_scenes() -> list[SlideScene]:
    ...
    s = SlideScene(2, "Overview", "Edge AI inference over a noisy link",
                   ("Motivation", "Objectives"),
                   "Tier 1 is a simulation-first supervised-learning experiment")
    minimal_header(s, s.title)
    steps = [
        ("1", "Observe", "An edge camera captures an image."),
        ("2", "Encode", "A neural model learns what to transmit."),
        ("3", "Communicate", "The representation crosses a limited noisy link."),
        ("4", "Infer", "The receiver AI predicts the image class."),
    ]
    ...
    s.text(1.02, 4.68, 3.15, 0.30, "AI/ML core", size=16,
           bold=True, font="sans", text_color=INK)
    ...
    s = SlideScene(3, "Conventional approach", "Conventional communication around an AI model",
    ...
    s = SlideScene(4, "Proposed approach", "The AI/ML method: end-to-end neural communication",
                   ("Motivation", "Objectives", "Subject Knowledge"),
                   "DJSCC = deep joint source–channel coding")
    minimal_header(s, s.title)
    learned_path = [
        (0.86, 1.62, 1.72, "Image", "sender input"),
        (3.10, 1.62, 2.14, "Residual CNN", "learned representation"),
        (5.76, 1.62, 1.86, "AWGN layer", "differentiable noise"),
        (8.14, 1.62, 2.30, "Dual-head decoder", "class + reconstruction"),
        (10.96, 1.62, 1.46, "Logits", "AI output"),
    ]
    ...
    s.text(1.02, 5.98, 10.98, 0.20,
           "Training objective: cross-entropy(class) + λ × MSE(reconstruction)",
    ...
    s = SlideScene(5, "Problem survey", "AI/ML and communication research gap",
                   ("Problem Survey", "Subject Knowledge"),
                   "30-source synthesis: docs/literature-review.md")
    minimal_header(s, s.title)
    topics = [
    ...
    s = SlideScene(6, "Objectives", "AI/ML problem statement and objectives",
                   ("Motivation", "Objectives"),
    ...
    s.text(0.78, 3.80, 2.46, 0.30, "Objectives", size=15.5,
           bold=True, font="sans", text_color=INK)
    objectives = [
        "Implement and train a residual neural encoder with a dual-head decoder.",
        "Build a task-aware digital feature control using the shared AI representation.",
    ...
    s = SlideScene(7, "Methodology", "AI/ML architecture and comparison design",
                   ("Objectives", "Subject Knowledge"),
    ...
    s = SlideScene(8, "Hypothesis", "AI evaluation hypotheses and analysis plan",
                   ("Hypothesis", "Subject Knowledge"),
    ...
    s = SlideScene(9, "Current status", "AI/ML feasibility demonstrated so far",
                   ("Subject Knowledge",),
    ...
    gantt_rows = [
        ...
        ("Neural training + λ calibration", date(2026, 8, 24), date(2026, 9, 21), "PLANNED", "D9D9D9", INK),
        ("AI feature control + validation", date(2026, 9, 21), date(2026, 10, 5), "PLANNED", "D9D9D9", INK),
    ...
    s = SlideScene(11, "Application and scope", "Edge AI application, AIML contribution and risks",
