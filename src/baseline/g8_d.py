...
def build_g8_d_contract(repo_root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    body: dict[str, Any] = {
        ...
        "smoke_schema": {
            "schema_version": 1,
            "artifact_role": "g8_d_bounded_non_scientific_smoke",
            ...
            "synthetic_codec_backend_only": True,
            "synthetic_decoder_only": True,
            "classifier_invocation_forbidden": True,
            "test_access_forbidden": True,
            "mutation_case_count": 20,  # literal-ok: closed D6 adversarial matrix size
            "mutation_case_names": [
